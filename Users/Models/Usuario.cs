...
namespace apitienda.Models
{
    ...
    public class Usuario
    {
        ...
        /// <summary>
        /// Obtiene o establece el token de restablecimiento de contraseña del usuario.
        /// </summary>
        public string? password_reset_token { get; set; }

        /// <summary>
        /// Obtiene o establece la fecha y hora de expiración del token de restablecimiento de contraseña del usuario.
        /// </summary>
